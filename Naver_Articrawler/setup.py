setup(
    ...
    description         = 'news crawler from naver',
    # 배포하는 사람의 이름을 작성합니다.
    author              = 'johnnyapu15',
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email        = 'johnnyapu15@gmail.com',
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url                 = 'https://github.com/johnnyapu15/naver_articrawler',
    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'https://github.com/johnnyapu15/naver_articrawler/archive/master.zip',
    ...
    # 패키지의 키워드를 적습니다.
    keywords            = ['news crawler naver article'],
